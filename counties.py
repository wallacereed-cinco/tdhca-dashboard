"""All 254 Texas counties, as TDHCA's search expects them (plain names)."""

TEXAS_COUNTIES: list[str] = [
    ...
    "Ector", "Edwards", "Ellis", "El Paso", "Erath", "Falls", "Fannin",
...
assert len(TEXAS_COUNTIES) == 254, f"expected 254, got {len(TEXAS_COUNTIES)}"
